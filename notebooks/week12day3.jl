...
# ╔═╡ b0512544-6b0b-477d-81b8-9b6b3fce2de1
using Plots
...
$(Resource("https://iancze.github.io/courses/astro542/lectures/30-star-formation-observations/vanthoff_thesis.png",:width=>"80%"))

Schematic overview of the different stages of low-mass star formation (left) and the observational classification based on the spectral energy distribution (right). 
Credit: [Merel van’t Hoff, Ph.D. thesis](https://ui.adsabs.harvard.edu/abs/2019PhDT........31V/abstract).
...
md"""
$(question_box(md"Are certain disk classes more common than others? "))
...
# ╔═╡ abb08987-c196-48ad-8ba5-cd554c8a9ad2
...
$(Resource("https://iancze.github.io/courses/astro589/lectures/01-introduction/alma.jpg",:width=>"80%"))
