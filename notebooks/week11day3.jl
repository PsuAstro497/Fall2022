...
# ╔═╡ 4d1fee33-5746-4f52-a4a0-782d7780a458
md"""
# More Reading questions
"""

# ╔═╡ 1a419e51-d31e-4e90-a69f-0551ca84e90e
question_box(md"""Why is microlensing an improbable phenomenon?""")

# ╔═╡ c1fc98a1-6c4b-4dd0-a12b-7eba279c7d92

question_box(md"""How would we be able to tell whether it is a planet or moon that was discovered if microlensing is potentially sensitive to large moon of exoplanets?""")

# ╔═╡ 666bba2f-96c5-4f2f-84e2-b79f9244f056
md"""
$(question_box(md"How feasible is it to commission a space telescope specifically to find exoplanets via microlensing?"))
- [Nancy Grace Roman Space Telescope](https://www.jpl.nasa.gov/missions/the-nancy-grace-roman-space-telescope)
$(Resource("https://roman.gsfc.nasa.gov/images/roman/100Percent/Roman_Mission_Details.jpg", :width=>"80%", :alt=>"Artist conception of Roman Space Telescope"))
--- Credit: NASA
"""

# ╔═╡ 8134a7b6-e18e-4be7-865e-b5497f18220f
question_box(md"""
- What proportion of objects detected with microlensing have masses less than that of Earth? 
- Has microlensing provided significant insight into the proportions of different-sized planets with large orbits?""")
